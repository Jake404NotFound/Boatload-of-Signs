...
public class ${name}Entity extends Boat {
    
    public ${name}Entity(EntityType<? extends Boat> type, Level level) {
        super(type, level);
    }

    public ${name}Entity(Level level, double x, double y, double z) {
        this(${JavaModName}EntityTypes.${registryname?upper_case}.get(), level);
        this.setPos(x, y, z);
    ...
    public Item getDropItem() {
        return ${JavaModName}Items.${registryname?upper_case}.get();
    }
