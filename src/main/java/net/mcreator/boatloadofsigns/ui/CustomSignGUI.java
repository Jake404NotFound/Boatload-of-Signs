...
public class CustomSignGUI extends ModElementGUI<CustomSign> {
    ...
    public CustomSignGUI(MCreator mcreator, ModElement modElement, boolean editingMode) {
    ...
    protected void initGUI() {
        texture = new TextureHolder(new File(""), 32, "Sign texture", mcreator);
        textureBack = new TextureHolder(new File(""), 32, "Sign back texture (optional)", mcreator);
        ...
        gbc.gridx = 0;
        gbc.gridy++;
        panel.add(HelpUtils.wrapWithHelpButton(this.withEntry("block/has_gravity"),
                L10N.label("elementgui.common.has_gravity")), gbc);
        gbc.gridx++;
        panel.add(hasGravity, gbc);
    ...
    public CustomSign getElementFromGUI() {
        CustomSign sign = new CustomSign(modElement);
        ...
        sign.hasGravity = hasGravity.isSelected();
    ...
    @Override
    public void setElementFromGUI(CustomSign sign) {
        ...
        hasGravity.setSelected(sign.hasGravity);
