...
public class CustomSignGenerator implements GeneratorTemplate {
    ...
    public List<GeneratorFile> generateElement(GeneratableElement element, 
        ...
        CustomSign sign = (CustomSign) element;
        ...
        dataModel.put("hasGravity", sign.hasGravity);
        ...
        generatorFiles.add(new GeneratorFile(
            "templates/neoforge-1.21.4/customsign/block.java.ftl",
        ...
        // Generate item class
        generatorFiles.add(new GeneratorFile(
            "templates/neoforge-1.21.4/customsign/item.java.ftl",
            element.getModElement().getSourceRoot() + "/" + element.getModElement().getPackageName()
        ...
        generatorFiles.add(new GeneratorFile(
            "templates/neoforge-1.21.4/customsign/blockentity.java.ftl",
            element.getModElement().getSourceRoot() + "/" + element.getModElement().getPackageName()
        ...
        generatorFiles.add(new GeneratorFile(
            "templates/neoforge-1.21.4/customsign/blockmodel.json.ftl",
        ...
        // Generate item model
        generatorFiles.add(new GeneratorFile(
            "templates/neoforge-1.21.4/customsign/itemmodel.json.ftl",
            element.getModElement().getResourceRoot() + "/assets/" + dataModel.get("modid")
        ...
        // Generate blockstate
        generatorFiles.add(new GeneratorFile(
            "templates/neoforge-1.21.4/customsign/blockstate.json.ftl",
            element.getModElement().getResourceRoot() + "/assets/" + dataModel.get("modid")
